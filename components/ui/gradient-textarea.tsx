...
export interface GradientTextareaProps extends React.ComponentProps<typeof Textarea> {
    ...
    return (
      <div 
        className={cn(
          ...
          "ring-1 ring-foreground/10 bg-transparent hollow-border-glow",
      ...
      >
        <div className="bg-background rounded-[14.5px] overflow-hidden">
          <Textarea
            className={cn(
              "border-none bg-transparent shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 px-5 py-[11px] min-h-[48px] h-12 resize-none overflow-hidden",
